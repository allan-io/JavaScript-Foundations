...
function mortgageCalculator() {
    ...
    const P = parseInt(window.prompt("enter total principal"))
    let I = parseFloat(window.prompt("enter loan interest rate"))
    const N = parseInt(window.prompt("enter total of years"))
